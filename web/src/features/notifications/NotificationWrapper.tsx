...
const useStyles = createStyles((theme, { glassStyle, iconColor, iconColorDim }: { glassStyle: any, iconColor: string, iconColorDim: string }) => ({
  container: {
    ...
    overflow: 'hidden',
    fontFamily: 'Roboto',
    background: 'var(--ox-notif-bg)',
    border: '1px solid var(--ox-notif-border)',
...
const Notifications: React.FC = () => {
  ...
  const notifPosition = config.theme.notificationPosition || 'top-right';
  ...
  useNuiEvent<NotificationProps>('notify', (data) => {
    ...
    // Config position overrides the script-provided position
    const configPos = notifPosition !== 'auto' ? notifPosition : (data.position || 'top-right');
